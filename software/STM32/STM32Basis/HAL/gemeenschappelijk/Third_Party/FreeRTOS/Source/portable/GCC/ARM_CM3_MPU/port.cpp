 ...
 */
extern "C" void xPortPendSVHandler( void ) __attribute__ (( naked )) PRIVILEGED_FUNCTION;
extern "C" void xPortSysTickHandler( void )  __attribute__ ((optimize("3"))) PRIVILEGED_FUNCTION;
extern "C" void vPortSVCHandler( void ) __attribute__ (( naked )) PRIVILEGED_FUNCTION;
